...
export const Users: React.FC = () => {
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    if (success) {
      setFormMsg({ type: 'success', text: 'Pengguna baru berhasil didaftarkan!' });
      setNameInput('');
      setPhoneInput('');
      setUsernameInput('');
      setPasswordInput('');
      ...
      setFormMsg({ type: 'error', text: 'Gagal mendaftarkan pengguna. Username atau nomor HP mungkin sudah terdaftar.' });
    }
  };
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border pb-4">
        ...
        <button
          ...
          className="px-4 py-2.5 bg-primary text-primary-foreground font-bold text-xs rounded-xl shadow-md hover:opacity-90 transition-all flex items-center gap-2 cursor-pointer shrink-0 self-start sm:self-auto"
        >
          <UserPlus size={16} />
      ...
      <div className="w-full p-5 rounded-2xl bg-card border border-border/80 shadow-sm flex flex-col gap-4">
          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-border py-4.5 px-5 bg-muted/30">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-sm text-foreground">Register New User Account</span>
              </div>
              <button 
                onClick={() => setShowCreateModal(false)}
